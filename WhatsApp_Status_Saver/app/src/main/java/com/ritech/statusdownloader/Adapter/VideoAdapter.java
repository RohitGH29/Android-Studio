...
//            holder.save.setVisibility(View.VISIBLE);
       ...
       /* holder.share.setOnClickListener(v -> {
        ...
        holder.imageView.setOnClickListener(v -> {
            ...
            // new added 30/09/23 for download images on full screen
            ImageButton save= alert2.findViewById(R.id.saveF);
            ImageButton share=alert2.findViewById(R.id.shareF);
            save.setOnClickListener(view -> Common.copyFile(status, context, container));
