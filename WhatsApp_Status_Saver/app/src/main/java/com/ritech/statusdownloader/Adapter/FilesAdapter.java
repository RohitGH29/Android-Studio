package com.ritech.statusdownloader.Adapter;
      ...
      /*  holder.save.setOnClickListener(view -> {
        ...
        holder.imageView.setOnClickListener(v -> {
            ...
            if (status.isVideo()) {
                ...
                alert2.show();
                /// new data add 01/10/23
                ImageButton delete= alert2.findViewById(R.id.saveF);
                ImageButton share=alert2.findViewById(R.id.shareF);
                delete.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.ic_baseline_delete_24));
                ...
                alert.show();
                ImageButton delete= alert.findViewById(R.id.saveF);
                ImageButton share=alert.findViewById(R.id.shareF);
                delete.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.ic_baseline_delete_24));
                delete.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
